  ...
  return (
	<>
		...
		<section className="flex flex-col items-center font-outfit pt-20 text-center h-screen text-zinc-800">
				...
				<Link rel="noopener noreferrer" to="/" className="hover:bg-zinc-600 bg-zinc-800 text-orange-200 p-2 px-3 sm:text-2xl text-lg rounded-xl mt-12">Retourner à la page d'accueil</Link>
