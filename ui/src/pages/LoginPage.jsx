      ...
      <nav class="nav sm:w-1/4 w-full">
        <Link class="text-white flex flex-row items-center pt-5 pl-5" to="/">
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            class="w-10 h-10 translate-y-0.5"
          >
            <path
        ...
        <div class="etape bg-white w-[600px] h-[500px] translate-y-[-20px] rounded-xl flex flex-col justify-between">
          <div class="haut flex flex-col items-center pt-5 px-5">
            ...
            <input
              type="text"
              placeholder="login"
              class="placeholder-zinc-600 text-xl mt-10 h-10 w-full rounded-xl border-2 border-zinc-800  focus:outline-none pl-2"
              value={username}
            ...
            <div class="mdp border-2 mt-5 h-10 rounded-xl border-zinc-800 flex flex-row w-full">
              <input
                ...
                class="placeholder-zinc-600 text-xl w-full rounded-xl focus:outline-none pl-2"
                value={password}
            ...
            <Link
              class="text-zinc-500 text-sm self-start hover:underline no-underline pl-1 pt-0.5"
              to="/forgotten"
            >
            ...
            <button
              class="bg-zinc-800 text-amber-50 px-3 py-1 rounded-lg mt-5 text-xl hover:bg-zinc-600"
            ...
            <h2 class="mt-1">
              ...
              <Link class="underline" to="/inscription">
                s'inscrire
              </Link>
              .
            </h2>
