...
function AccueilPage() {
    ...
    return (
        ...
        <main className="main-container bg-zinc-50 flex flex-col sm:p-5 p-0"> 
                ...
                <div className="vs">
                        <div className="fin_proche flex flex-col sm:gap-5 gap-0.5 text-white sm:mt-10 mt-2">
                            <section className="top font-outfit p-2 sm:h-60 h-30 relative flex flex-col justify-center items-center sm:rounded-xl rounded-none bg-black bg-center bg-no-repeat bg-100 w-1/2">
