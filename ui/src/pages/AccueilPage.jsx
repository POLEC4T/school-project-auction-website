      ...
      <main className="main-container bg-zinc-50 flex flex-col sm:p-5 p-0">
        ...
        <div className="vs flex sm:flex-row flex-col w-full mt-10 sm:gap-5 gap-0">
          <div className="selection sm:w-1/2 w-full flex flex-col bg-zinc-600 items-center sm:rounded-xl rounded-none px-10 justify-between text-white">
            <h2 className="font-square sm:text-6xl text-4xl mt-2">
              Notre sélection
            </h2>
            <p className="font-outfit text-center sm:text-xl text-md">
              Notre sélection de vêtements faits-mains vous offre la possibilité
              de découvrir des pièces uniques et élégantes, créées par des
              artisans talentueux.
            </p>
            <button className="w-1/2 h-auto sm:mt-0 mt-3 ease-in duration-500 hover:w-4/6">
              <img src={imgShop} alt="image-shop" />
            </button>
          </div>
