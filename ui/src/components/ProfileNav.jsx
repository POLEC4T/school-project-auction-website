...
function ProfileNav(props){
    ...
    if(props.role === "ROLE_VENDEUR"){
        return(
            ...
            <button class="bg-zinc-700 hover:bg-zinc-500 flex justify-center w-1/2 items-center ease-in duration-100" value="historique" onClick={(e)=>handleButtonClick(e)}>
                ventes
            </button>
            </nav>
        )
        ...
        return(
            ...
            <button class="bg-zinc-700 hover:bg-zinc-500 flex justify-center w-1/3 items-center ease-in duration-100" value="historique" onClick={(e)=>handleButtonClick(e)}>
                commandes
            </button>
