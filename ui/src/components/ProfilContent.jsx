    ...
    <>
      {user && user.roleId === 1 ? (
        <>
          <section class="bottom-profil sm:px-28 px-4 font-outfit">
            ...
            <div class="middle2 mt-12 flex sm:flex-row flex-col">
              <div class="stats flex sm:flex-col flex-row sm:w-1/6 w-full rounded-xl sm:text-xl text-lg font-chivo justify-around text-center rounded-xl opacity-30">
        ...
        <section class="bottom-profil sm:px-28 px-4 font-outfit">
          ...
          <div class="middle2 mt-12 flex sm:flex-row flex-col justify-center items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
            ...
            <p class="profil-pas-vendeur sm:text-2xl text-xl sm:ml-5 ml-0 text-center">
